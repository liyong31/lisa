...
* [Spot model checker](https://spot.lrde.epita.fr/) -- placed in third_parties/ folder

* [MONA](https://github.com/liyong31/MONA) -- placed in third_parties/ folder

* [args] (https://github.com/Taywee/args) -- placed into third_parties folder (see CMakeLists.txt)

* [pstreams-1.0.3] (https://pstreams.sourceforge.net/download/) -- placed in third_parties/ folder
